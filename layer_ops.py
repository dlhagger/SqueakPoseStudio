"""Qt-free layer definitions shared across SqueakPose workflows."""
...
def layer_worker_mode(value: Any) -> str:
    """Return the legacy-compatible worker mode for a layer."""

    return layer_definition(value).worker_mode


def layer_model_task(value: Any) -> str:
    """Return the Ultralytics task expected for a layer's model."""
