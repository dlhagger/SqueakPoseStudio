...
from squeakpose.core import parse_yolo_pose_label_line as _parse_yolo_pose_label_line
...
def parse_pose_label_line(
    ...
    *,
    ...
    return _parse_yolo_pose_label_line(
        line,
...
def segmentation_annotation_to_line(
    entry: dict[str, Any],
    *,
    img_w: float,
    img_h: float,
